...
class TestExportHelperValidation(unittest.TestCase):
    ...
    def test_sorted_dict(self):
        ...
        assert expected_dictdata == response_dictdata
        assert expected_ordereddict_data == response_ordereddict_data
        assert expected_list_data == response_list_data)
    ...
    def test_make_filename(self):
        ...
        assert response_with_doublequotes == actual_response
        ...
        assert response_with_forwardslash == actual_response
        ...
        assert response_with_backslash == actual_response
        ...
        assert response_with_verticalbar==actual_response
        ...
        assert response_with_semicolon == actual_response
