...
class TestSystemNotificationHelperValidation(OpenEventTestCase):
    ...
    def test_get_event_role_notification_actions(self):
    ...
    def test_get_new_session_notification_actions(self):
    ...
    def test_get_next_event_notification_actions(self):
    ...
    def test_get_session_accept_reject_notification_actions(self):
