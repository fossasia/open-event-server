...
@hooks.before(
    "Events > Events for a Discount Code > List All Events for a Discount Code"
)
...
@hooks.before(
    "Events > Get Event for a Session Type > Event Details for a Session Type"
)
...
@hooks.before(
    "Sessions > List Sessions under a Speaker > List Sessions under a Speaker"
)
...
@hooks.before(
    "Speakers > List Speakers under a Session > List Speakers under a Session"
)
...
@hooks.before(
    "Image Size > Speaker Image Size Details > Get Speaker Image Size Details"
)
...
@hooks.before(
    "Message Settings > Message Setting Details > Get Message Setting Details"
)
...
@hooks.before(
    "Event Topics > Event Topic of an Event > Event Topic Details of an Event"
)
...
# ------------------------- User Permissions -------------------------
@hooks.before(
    "User Permissions > User Permission Collection > List all user permissions"
)
...
@hooks.before(
    "User Permissions > User Permission Details > Get User Permission Details"
)
...
@hooks.before(
    "Favourite Events > Favourite Events Collection > Create a Favourite Event"
)
