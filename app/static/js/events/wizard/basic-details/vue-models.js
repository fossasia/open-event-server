...
var EVENT = {
    ...
    location_name: '',
    show_map: true,
    starts_at_date: moment().add(1, 'months').format('MM/DD/YYYY'),
    starts_at_time: moment().add(1, 'months').hour(10).minute(0).format('HH:mm'),
    ends_at_date: moment().add(1, 'months').format('MM/DD/YYYY'),
    ends_at_time: moment().add(1, 'months').hour(17).minute(0).format('HH:mm'),
...
var TICKET = {
    ...
    sales_starts_at: moment().format('HH:mm'),
    sales_end_date: moment().add(10, 'days').format('MM/DD/YYYY'),
    sales_ends_at: moment().add(10, 'days').hour(22).minute(0).format('HH:mm'),
    min_order: 1,
    max_order: 10,
    tags_string: '',
