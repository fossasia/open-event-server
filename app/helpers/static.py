...
EVENT_LICENCES = {
    ...
    'Attribution-NoDerivs': (
        ...
        u'This license allows for redistribution, commercial and non-commerci'
        u'al, as long as it is passed along unchanged and in whole, with credit to the copyright holder.',
