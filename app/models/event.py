...
class Event(SoftDeletionModel):
    ...
    is_promoted: bool = db.Column(db.Boolean, default=False, nullable=False)
    ...
    is_billing_info_mandatory: bool = db.Column(db.Boolean, default=False, nullable=False)
