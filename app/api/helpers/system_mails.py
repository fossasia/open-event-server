...
MAILS = {
    MailType.SESSION_STATE_CHANGE: {
        'recipient': 'Speaker',
        'pending': {
            'subject': lazy_gettext('Your speaker submission for {event_name} titled {session_name}'),
            'message': "Hello,<br/><br/>"
        ...
        'accepted': {
            'subject': lazy_gettext('Accepted! Congratulations Your submission for {event_name} titled {session_name} has been Accepted'),
            'message': "Hello,<br/><br/>"
            "This is an automatic message from {app_name}.<br/><br/>"
        ...
        'confirmed': {
            'subject': lazy_gettext('Confirmed! Congratulations Your submission for {event_name} titled {session_name} has been Confirmed'),
            'message': "Hello,<br/><br/>"
            "This is an automatic message from {app_name}.<br/><br/>"
        ...
        'rejected': {
            'subject': lazy_gettext('Not Accepted. Your submission for {event_name} titled {session_name} was not accepted'),
            'message': "Hello,<br/><br/>"
            "This is an automatic message from {app_name}.<br/><br/>"
        ...
        'canceled': {
            'subject': lazy_gettext('Canceled! Your submission for {event_name} titled {session_name} has been Canceled'),
            'message': "Hello,<br/><br/>"
            "This is an automatic message from {app_name}.<br/><br/>"
        ...
        'withdrawn': {
            'subject': lazy_gettext('Withdrawn! Your submission for {event_name} titled {session_name} has been Withdrawn'),
            'message': "Hello,<br/><br/>"
            "This is an automatic message from {app_name}.<br/><br/>"
    ...
    MailType.TICKET_SALES_END: {
        ...
        'subject': lazy_gettext('Ticket Sales Period for One or Several Tickets for {event_name} Ended'),
        'template': 'email/ticket_sales_end.html',
    },
    MailType.TICKET_SALES_END_TOMORROW: {
        'recipient': 'Owner, Organizer',
        'subject': lazy_gettext('Ticket Sales Period for One or Several Tickets for {event_name} Ending in 24 Hours'),
        'template': 'email/ticket_sales_end_tomorrow.html',
    },
    MailType.TICKET_SALES_END_NEXT_WEEK: {
        'recipient': 'Owner, Organizer',
        'subject': lazy_gettext('Ticket Sales Period fors One or Several Tickets for {event_name} Ending in 7 Days'),
        'template': 'email/ticket_sales_end_next_week.html',
    },
    MailType.NEW_SESSION: {
        'recipient': 'Owner, Organizer',
        'subject': lazy_gettext('New session proposal for {session.event.name} titled {session.title}'),
        'template': 'email/new_session.html',
    },
    MailType.USER_REGISTER: {
        'recipient': 'User',
        'subject': lazy_gettext('Welcome to {app_name}. Please verify your account'),
        'template': 'email/user_register.html',
    },
    MailType.USER_CONFIRM: {
        'recipient': 'User',
        'subject': lazy_gettext('Email Confirmation to Create Account for {app_name}'),
        'template': 'email/user_confirm.html',
    },
    MailType.USER_CHANGE_EMAIL: {
        'recipient': 'User',
        'subject': lazy_gettext('Your email has been already changed'),
        'template': 'email/user_change_email.html',
    },
    MailType.PASSWORD_RESET: {
        'recipient': 'User',
        'subject': lazy_gettext('{app_name}: Password Reset'),
        'template': 'email/password_reset.html',
    },
    MailType.PASSWORD_RESET_AND_VERIFY: {
        'recipient': 'User',
        'subject': lazy_gettext('{app_name}: Reset your password and verify your account'),
        'template': 'email/password_reset_and_verify.html',
    },
    MailType.PASSWORD_CHANGE: {
        'recipient': 'User',
        'subject': lazy_gettext('{app_name}: Password Change'),
        'template': 'email/password_change.html',
    },
    MailType.EVENT_ROLE: {
        'recipient': 'User',
        'subject': lazy_gettext('Invitation to be {role} at Event: {event}'),
        'template': 'email/event_role.html',
    },
    MailType.SPEAKER_INVITE: {
        'recipient': 'User',
        'subject': lazy_gettext('Invitation to be speaker at Session: {session}'),
        'template': 'email/speaker_invite.html',
    },
    MailType.GROUP_ROLE: {
        'recipient': 'User',
        'subject': lazy_gettext('Invitation to be {role} at Group: {group}'),
        'template': 'email/group_role.html',
    },
    MailType.TICKET_PURCHASED: {
        'recipient': 'User',
        'subject': lazy_gettext('See you at {event_name} on {event_date} at {event_time} ({invoice_id}) '),
        'template': 'email/ticket_purchased.html',
    },
    MailType.TICKET_PURCHASED_ATTENDEE: {
        'recipient': 'Attendee',
        'subject': lazy_gettext('Your tickets for {event_name} on {event_date} at {event_time} ({invoice_id}) '),
        'template': 'email/ticket_purchased_attendee.html',
    },
    MailType.TICKET_PURCHASED_ORGANIZER: {
        'recipient': 'Owner, Organizer, Coorganizer',
        'subject': lazy_gettext('New order for {event_name} on {event_date} by {buyer_name}, {buyer_email} ({invoice_id}) '),
        'template': 'email/ticket_purchased_organizer.html',
    },
    MailType.TICKET_CANCELLED: {
        'recipient': 'User',
        'subject': lazy_gettext('Your order for {event_name} has been cancelled ({invoice_id})'),
        'template': 'email/ticket_cancelled.html',
    },
    MailType.EVENT_EXPORTED: {
        'recipient': 'User',
        'subject': lazy_gettext('Event {event_name} has been exported'),
        'template': 'email/event_exported.html',
    },
    MailType.EVENT_EXPORT_FAIL: {
        'recipient': 'User',
        'subject': lazy_gettext('Export of event {event_name} failed'),
        'template': 'email/event_export_fail.html',
    },
    MailType.MONTHLY_PAYMENT: {
        'recipient': 'Owner',
        'subject': lazy_gettext('Your invoice for {event_name} for {date} is available on {app_name}'),
        'sent_at': '1st day of the month',
        'template': 'email/monthly_payment_email.html',
    },
    MailType.MONTHLY_PAYMENT_FOLLOWUP: {
        'recipient': 'Owner',
        'subject': lazy_gettext('Reminder: Your invoice for {event_name} for {date} is available on {app_name}'),
    ...
    MailType.MONTHLY_PAYMENT_POST_DUE: {
        'recipient': 'Owner',
        'subject': lazy_gettext('Please pay your overdue invoice for {event_name} for {date} on {app_name}'),
        'sent_at': '30th day of the month',
        'template': 'email/monthly_payment_post_due_email.html',
    },
    MailType.EVENT_IMPORTED: {
        'recipient': 'User',
        'subject': lazy_gettext('Event {event_name} has been imported'),
        'template': 'email/event_imported.html',
    },
    MailType.EVENT_IMPORT_FAIL: {
        'recipient': 'User',
        'subject': lazy_gettext('Import of event failed'),
    ...
    MailType.TEST_MAIL: {
        'recipient': 'User',
        'subject': lazy_gettext('Test Mail Subject'),
        'message': ("This is a  <strong> Test </strong> E-mail."),
    },
    MailType.VIDEO_MODERATOR_INVITE: {
        'recipient': 'User',
        'subject': lazy_gettext('Video Moderator of video {video_name} at event {event_name}'),
        'template': 'email/video_stream_moderator.html',
    },
    MailType.ANNOUNCE_EVENT: {
        'recipient': 'User',
        'subject': lazy_gettext('Join {event_name} from {group_name} on {event_date}'),
        'template': 'email/announce_event.html',
    },
    MailType.AFTER_EVENT: {
        'recipient': 'Owner, Organizer, Coorganizer',
        'subject': lazy_gettext('{event_name} is over. Thank you for using {app_name}!'),
        'template': 'email/after_event.html',
    },
    MailType.AFTER_EVENT_SPEAKER: {
        'recipient': 'User',
        'subject': lazy_gettext('{event_name} is over. Thank you for participating!'),
