...
from app.api.helpers.import_helpers import get_file_from_request, import_event_json
...
def import_event(source_type):
    ...
    task = import_event_task.delay(file=file_path, source_type=source_type, creator_id=current_identity.id)
