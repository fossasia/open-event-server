...
# event_image_sizes
api.route(EventImageSizeDetail, 'event_image_size_detail', '/event-image-sizes/<int:id>')

# speaker_image_sizes
api.route(SpeakerImageSizeDetail, 'speaker_image_size_detail', '/speaker-image-sizes/<int:id>')
