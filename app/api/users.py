...
user_misc_routes = Blueprint('user_misc', __name__, url_prefix='/v1')import base64
...
class UserDetail(ResourceDetail):
    ...
    def before_update_object(self, user, data, view_kwargs):
        ...
        if has_access('is_admin') and ('is_marketer' in data) and data.get('is_marketer') != user.is_marketer:
