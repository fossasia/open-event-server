...
class AttendeeSchemaPublic(SoftDeletionSchema):
    ...
    email = fields.Str(allow_none=True, default="Not Specified")
    address = fields.Str(allow_none=True, default="Not Specified")
    city = fields.Str(allow_none=True, default="Not Specified")
    state = fields.Str(allow_none=True, default="Not Specified")
    country = fields.Str(allow_none=True, default="Not Specified")
    job_title = fields.Str(allow_none=True, default="Not Specified")
    phone = fields.Str(allow_none=True, default="Not Specified")
    tax_business_info = fields.Str(allow_none=True, default="Not Specified")
    billing_address = fields.Str(allow_none=True, default="Not Specified")
    home_address = fields.Str(allow_none=True, default="Not Specified")
    shipping_address = fields.Str(allow_none=True, default="Not Specified")
    company = fields.Str(allow_none=True, default="Not Specified")
    work_address = fields.Str(allow_none=True, default="Not Specified")
    work_phone = fields.Str(allow_none=True, default="Not Specified")
    ...
    gender = fields.Str(allow_none=True, default="Not Specified")
