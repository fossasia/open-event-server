...
class EventSchemaPublic(SoftDeletionSchema):
    ...
    external_event_url = fields.Url(allow_none=True, validate=validate.URL(schemes=["https"]))
    ...
    logo_url = fields.Url(allow_none=True, validate=validate.URL(schemes=["https"]))
    location_name = fields.Str(allow_none=True)
    searchable_location_name = fields.Str(allow_none=True)
    description = fields.Str(allow_none=True)
    original_image_url = fields.Url(allow_none=True, validate=validate.URL(schemes=["https"]))
    ...
    ticket_url = fields.Url(allow_none=True, validate=validate.URL(schemes=["https"]))
    ...
    pentabarf_url = fields.Url(dump_only=True, validate=validate.URL(schemes=["https"]))
    ical_url = fields.Url(dump_only=True, validate=validate.URL(schemes=["https"]))
    xcal_url = fields.Url(dump_only=True, validate=validate.URL(schemes=["https"]))
