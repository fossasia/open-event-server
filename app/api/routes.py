...
from app.api.event_topics import (
    EventTopicList,
    EventTopicDetail,
...
api.route(
    UserEmailRelationship,
    'user_emails_user',
    '/user-emails/<int:id>/relationships/user',
)
...
api.route(
    UserFavouriteEventListPost,
    'user_favourite_event_list_post',
    '/user-favourite-events',
)
api.route(
    UserFavouriteEventList,
...
api.route(
    SessionRelationshipOptional,
    'session_track',
    '/sessions/<int:id>/relationships/track',
)
api.route(
    SessionRelationshipOptional,
...
api.route(
    SponsorRelationship, 'sponsor_event', '/sponsors/<int:id>/relationships/event'
)
...
api.route(
    TrackRelationshipOptional,
    'track_sessions',
    '/tracks/<int:id>/relationships/sessions',
)
api.route(
...
api.route(
    SpeakerRelationshipRequired,
    'speaker_event',
    '/speakers/<int:id>/relationships/event',
)
api.route(
...
api.route(
    FeedbackRelationship, 'feedback_user', '/feedbacks/<int:id>/relationships/user'
)
api.route(
    FeedbackRelationship,
    'feedback_session',
...
api.route(
    AdminSalesByOrganizersList,
    'admin_sales_by_organizers',
    '/admin/sales/by-organizers',
)
api.route(
    AdminSalesByLocationList, 'admin_sales_by_location', '/admin/sales/by-location'
)
api.route(
    AdminSalesByMarketerList, 'admin_sales_by_marketer', '/admin/sales/by-marketer'
)
