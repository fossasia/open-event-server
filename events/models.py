...
class Event(models.Model):
    ...
    event_topic = models.ForeignKey(EventTopic, on_delete=models.CASCADE, null=True)
    event_sub_topic = models.ForeignKey(EventSubTopic, on_delete=models.CASCADE, null=True)
