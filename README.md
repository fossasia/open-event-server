...
[![GitHub release](https://img.shields.io/badge/release-1.0.0--alpha.8-blue.svg?style=flat-square)](https://github.com/fossasia/open-event-orga-server/releases/latest)
