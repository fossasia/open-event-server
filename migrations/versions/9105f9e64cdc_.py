...
def upgrade():
    ...
    op.create_foreign_key(
        u'sessions_microlocation_id_fkey',
        'sessions',
        'microlocations',
        ['microlocation_id'],
        ['id'],
    ...
    op.create_foreign_key(
        u'sessions_session_type_id_fkey',
        'sessions',
        'session_types',
        ['session_type_id'],
        ['id'],
    ...
    op.drop_constraint(
        u'email_notification_event_id_fkey', 'email_notifications', type_='foreignkey'
    )
    op.create_foreign_key(
        u'email_notifications_event_id_fkey',
        'email_notifications',
        'events',
        ['event_id'],
        ['id'],
    ...
    op.drop_constraint(
        u'session_type_event_id_fkey', 'session_types', type_='foreignkey'
    )
    op.create_foreign_key(
        u'session_types_event_id_fkey',
        'session_types',
        'events',
        ['event_id'],
        ['id'],
    ...
    op.drop_constraint(
        u'microlocation_event_id_fkey', 'microlocations', type_='foreignkey'
    )
    op.create_foreign_key(
        u'microlocations_event_id_fkey',
        'microlocations',
        'events',
        ['event_id'],
        ['id'],
    ...
    op.drop_constraint(
        u'event_copyright_event_id_fkey', 'event_copyrights', type_='foreignkey'
    )
    op.create_foreign_key(
        u'event_copyrights_event_id_fkey',
        'event_copyrights',
        'events',
        ['event_id'],
        ['id'],
    ...
    op.drop_constraint(
        u'access_codes_marketer_id_fkey', 'access_codes', type_='foreignkey'
    )
    op.create_foreign_key(
        u'access_codes_marketer_id_fkey',
        'access_codes',
        'users',
        ['marketer_id'],
        ['id'],
    ...
    op.drop_constraint(
        u'discount_codes_marketer_id_fkey', 'discount_codes', type_='foreignkey'
    )
    op.create_foreign_key(
        u'discount_codes_marketer_id_fkey',
        'discount_codes',
        'users',
        ['marketer_id'],
        ['id'],
    ...
    op.drop_constraint(
        u'email_notification_user_id_fkey', 'email_notifications', type_='foreignkey'
    )
    op.create_foreign_key(
        u'email_notifications_user_id_fkey',
        'email_notifications',
        'users',
        ['user_id'],
        ['id'],
    ...
    op.drop_constraint(
        u'event_invoices_user_id_fkey', 'event_invoices', type_='foreignkey'
    )
    op.create_foreign_key(
        u'event_invoices_user_id_fkey',
        'event_invoices',
        'users',
        ['user_id'],
        ['id'],
    ...
    op.create_foreign_key(
        u'transaction_user_id_fkey', 'transaction', 'users', ['user_id'], ['id']
    )
    op.drop_constraint(
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            'reset_password', sa.VARCHAR(length=128), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            'signup_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column(
            'last_accessed_at',
    ...
    op.drop_constraint(u'transaction_user_id_fkey', 'transaction', type_='foreignkey')
    op.create_foreign_key(
        u'transaction_user_id_fkey', 'transaction', 'temp_user', ['user_id'], ['id']
    )
    op.drop_constraint(u'speaker_user_id_fkey', 'speaker', type_='foreignkey')
    op.create_foreign_key(
        u'speaker_user_id_fkey',
    ...
    op.drop_constraint(
        u'email_notifications_user_id_fkey', 'email_notifications', type_='foreignkey'
    )
    op.create_foreign_key(
        u'email_notifications_user_id_fkey',
        'email_notifications',
    ...
    op.execute(
        "INSERT INTO temp_user SELECT id, email, password, reset_password, salt, avatar, tokens, is_super_admin, is_admin, is_verified, signup_at, last_accessed_at, created_at, deleted_at from users"
    )
    op.execute(
        "INSERT INTO user_detail SELECT id, firstname, lastname, details, avatar, contact, facebook, twitter, instagram, google, avatar_uploaded, thumbnail, small, icon, id from users"
    )
