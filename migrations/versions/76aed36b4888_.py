...
def upgrade():
    ...
    op.add_column(
        'events_version',
        sa.Column(
            'can_pay_by_alipay', sa.Boolean(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        'settings', sa.Column('alipay_publishable_key', sa.String(), nullable=True)
    )
    op.add_column(
        'settings', sa.Column('alipay_secret_key', sa.String(), nullable=True)
    )
