...
def upgrade():
    ...
    op.alter_column(
        'events', 'has_session_speakers', new_column_name='has_sessions_speakers'
    )
    op.alter_column('events', 'sponsors_enabled', new_column_name='is_sponsors_enabled')
    op.drop_column('events', 'email')

    op.alter_column(
        'events_version', 'pay_by_stripe', new_column_name='can_pay_by_stripe'
    )
    op.alter_column('events_version', 'pay_by_bank', new_column_name='can_pay_by_bank')
    op.alter_column(
        'events_version', 'pay_by_paypal', new_column_name='can_pay_by_paypal'
    )
    op.alter_column(
        'events_version', 'pay_by_cheque', new_column_name='can_pay_by_cheque'
    )
    ...
    op.alter_column(
        'events_version', 'ticket_include', new_column_name='is_ticketing_enabled'
    )
    op.alter_column(
        'events_version',
    ...
    op.alter_column(
        'events_version', 'sponsors_enabled', new_column_name='is_sponsors_enabled'
    )
    op.drop_column('events_version', 'email')

    op.execute('ALTER TABLE events ALTER COLUMN show_map drop default')
    op.execute(
        'ALTER TABLE events ALTER COLUMN show_map TYPE BOOLEAN USING (show_map::boolean)'
    )
    ...
    op.execute(
        'ALTER TABLE events_version ALTER COLUMN show_map TYPE BOOLEAN USING (show_map::boolean)'
    )
...
def downgrade():
    ...
    op.alter_column(
        'events', 'has_sessions_speakers', new_column_name='has_session_speakers'
    )
    ...
    op.alter_column(
        'events_version', 'can_pay_by_stripe', new_column_name='pay_by_stripe'
    )
    op.alter_column('events_version', 'can_pay_by_bank', new_column_name='pay_by_bank')
    op.alter_column(
        'events_version', 'can_pay_by_paypal', new_column_name='pay_by_paypal'
    )
    op.alter_column(
        'events_version', 'can_pay_by_cheque', new_column_name='pay_by_cheque'
    )
    ...
    op.alter_column(
        'events_version', 'is_ticketing_enabled', new_column_name='ticket_include'
    )
    op.alter_column(
        'events_version', 'is_sponsors_enabled', new_column_name='sponsors_enabled'
    )
    ...
    op.execute(
        'ALTER TABLE events ALTER COLUMN is_map_shown TYPE INTEGER USING (is_map_shown::integer)'
    )
