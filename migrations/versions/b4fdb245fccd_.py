...
def upgrade():
    ...
    op.add_column(
        'ticket_holders', sa.Column('billing_address', sa.String(), nullable=True)
    )
    op.add_column(
        'ticket_holders',
    ...
    op.add_column(
        'ticket_holders', sa.Column('home_address', sa.String(), nullable=True)
    )
    ...
    op.add_column(
        'ticket_holders', sa.Column('shipping_address', sa.String(), nullable=True)
    )
    op.add_column(
        'ticket_holders', sa.Column('tax_business_info', sa.String(), nullable=True)
    )
    ...
    op.add_column(
        'ticket_holders', sa.Column('work_address', sa.String(), nullable=True)
    )
