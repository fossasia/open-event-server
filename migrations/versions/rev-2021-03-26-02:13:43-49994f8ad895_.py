...
def upgrade():
    # ### commands auto generated by Alembic - please adjust! ###
        ...
        op.add_column('events', sa.Column('chat_room_name', sa.String(), nullable=True))
        op.add_column('events_version', sa.Column('chat_room_name', sa.String(), autoincrement=False, nullable=True))
...
def downgrade():
    ...
    op.drop_column('events_version', 'chat_room_name')
    op.drop_column('events', 'chat_room_name')
    # ### end Alembic commands ###
