...
def upgrade():
    ...
    op.alter_column(
        'message_settings', 'notif_status', new_column_name='notification_status'
    )
    ...
    op.alter_column(
        'tax', 'tax_include_in_price', new_column_name='is_tax_included_in_price'
    )
    ...
    op.alter_column(
        'sessions_version', 'state_email_sent', new_column_name='is_mail_sent'
    )
    ...
    op.drop_constraint(
        u'panel_permissions_role_id_fkey', 'panel_permissions', type_='foreignkey'
    )
    op.create_foreign_key(
        u'panel_permissions_role_id_fkey',
        'panel_permissions',
        'custom_sys_roles',
        ['role_id'],
        ['id'],
    ...
    op.drop_constraint(
        u'speakers_sessions_session_id_fkey', 'speakers_sessions', type_='foreignkey'
    )
    op.create_foreign_key(
        u'speakers_sessions_session_id_fkey',
        'speakers_sessions',
        'sessions',
        ['session_id'],
        ['id'],
...
def downgrade():
    ...
    op.alter_column(
        'message_settings', 'notification_status', new_column_name='notif_status'
    )
    ...
    op.alter_column(
        'tax', 'is_tax_included_in_price', new_column_name='tax_include_in_price'
    )
    ...
    op.alter_column(
        'session_version', 'is_mail_sent', new_column_name='state_email_sent'
    )
