...
def upgrade():
    ...
    op.add_column(
        'faq', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
    ...
    op.add_column(
        'speaker', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
    ...
    op.add_column(
        'ticket_tag', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        'tickets', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
        'user_permissions',
        sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    ...
    op.add_column(
        'tracks', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True)
    )
    op.add_column(
