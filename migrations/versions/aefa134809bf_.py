...
def upgrade():
    ...
    op.add_column(
        'custom_forms', sa.Column('field_identifier', sa.String(), nullable=False)
    )
    ...
    op.create_unique_constraint(
        ...
        'custom_forms',
        ['event_id', 'field_identifier', 'form'],
    )
...
def downgrade():
    ...
    op.add_column(
        'custom_forms',
        sa.Column('session_form', sa.VARCHAR(), autoincrement=False, nullable=False),
    )
    op.add_column(
        'custom_forms',
        sa.Column('speaker_form', sa.VARCHAR(), autoincrement=False, nullable=False),
    )
