...
def upgrade():
    ...
    op.add_column(
        'settings',
        sa.Column('admin_billing_additional_info', sa.String(), nullable=True),
    )
    op.add_column(
        'settings', sa.Column('admin_billing_address', sa.String(), nullable=True)
    )
    op.add_column(
        'settings', sa.Column('admin_billing_city', sa.String(), nullable=True)
    )
    op.add_column(
        'settings', sa.Column('admin_billing_contact_name', sa.String(), nullable=True)
    )
    op.add_column(
        'settings', sa.Column('admin_billing_country', sa.String(), nullable=True)
    )
    op.add_column(
        'settings', sa.Column('admin_billing_email', sa.String(), nullable=True)
    )
    op.add_column(
        'settings', sa.Column('admin_billing_phone', sa.String(), nullable=True)
    )
    op.add_column(
        'settings', sa.Column('admin_billing_tax_info', sa.String(), nullable=True)
    )
    op.add_column(
        'settings', sa.Column('admin_billing_zip', sa.String(), nullable=True)
    )
