...
def upgrade():
    ...
    op.execute(
        "alter table discount_codes alter column code type citext;",
        execution_options=None,
    )
    op.create_unique_constraint(
        'uq_event_discount_code', 'discount_codes', ['event_id', 'code']
    )
...
def downgrade():
    ...
    op.execute(
        "alter table discount_codes alter column code type text;",
        execution_options=None,
    )
