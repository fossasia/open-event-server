...
def upgrade():
    ...
    op.add_column(
        'sessions', sa.Column('complex_field_values', sa.JSON(), nullable=True)
    )
    op.add_column(
        'sessions_version',
        sa.Column(
            'complex_field_values', sa.JSON(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        'speaker', sa.Column('complex_field_values', sa.JSON(), nullable=True)
    )
    op.add_column(
        'ticket_holders', sa.Column('complex_field_values', sa.JSON(), nullable=True)
    )
    op.add_column(
        'settings',
        sa.Column(
