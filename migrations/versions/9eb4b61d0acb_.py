...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            'organizer_description', sa.String(), autoincrement=False, nullable=True
        ),
        sa.Column('privacy', sa.String(), autoincrement=False, nullable=True),
        sa.Column('state', sa.String(), autoincrement=False, nullable=True),
        sa.Column(
            'closing_datetime', sa.DateTime(), autoincrement=False, nullable=True
        ),
    ...
    op.create_index(
        op.f('ix_session_version_operation_type'),
        'session_version',
        ['operation_type'],
        unique=False,
    )
    op.create_index(
        op.f('ix_session_version_transaction_id'),
        'session_version',
        ['transaction_id'],
        unique=False,
    )
    op.create_table(
        'speakers_sessions_version',
    ...
    op.create_index(
        op.f('ix_speakers_sessions_version_operation_type'),
        'speakers_sessions_version',
        ['operation_type'],
        unique=False,
    )
    op.create_index(
        op.f('ix_speakers_sessions_version_transaction_id'),
        'speakers_sessions_version',
        ['transaction_id'],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f('ix_speakers_sessions_version_transaction_id'),
        table_name='speakers_sessions_version',
    )
    op.drop_index(
        op.f('ix_speakers_sessions_version_operation_type'),
        table_name='speakers_sessions_version',
    ...
    op.drop_index(
        op.f('ix_session_version_transaction_id'), table_name='session_version'
    )
    op.drop_index(
        op.f('ix_session_version_operation_type'), table_name='session_version'
    )
