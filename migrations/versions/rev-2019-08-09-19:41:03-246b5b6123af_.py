...
def upgrade():
    ...
    op.add_column(
        'settings', sa.Column('paytm_live_merchant', sa.String(), nullable=True)
    )
    op.add_column(
        'settings', sa.Column('paytm_live_secret', sa.String(), nullable=True)
    )
    op.add_column('settings', sa.Column('paytm_mode', sa.String(), nullable=True))
    op.add_column(
        'settings', sa.Column('paytm_sandbox_merchant', sa.String(), nullable=True)
    )
    op.add_column(
        'settings', sa.Column('paytm_sandbox_secret', sa.String(), nullable=True)
    )
    op.add_column(
        'settings',
        sa.Column(
            'is_paytm_activated', sa.Boolean(), server_default='False', nullable=False
        ),
    )
