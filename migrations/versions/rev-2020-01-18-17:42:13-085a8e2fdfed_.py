...
def upgrade():
    ...
    op.add_column('events', sa.Column('is_promoted', sa.Boolean(), nullable=False))
    op.add_column('events_version', sa.Column('is_promoted', sa.Boolean(), autoincrement=False, nullable=True))
