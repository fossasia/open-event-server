...
def upgrade():
    ...
    op.add_column(
        'settings', sa.Column('cookie_policy_link', sa.String(), nullable=True)
    )
    op.drop_column('users', 'has_accepted_cookie_policy')
    # ### end Alembic commands ###
    settings_table = sa.sql.table(
        'settings',
        sa.Column('cookie_policy', sa.String()),
    ...
    op.execute(
        ...
        .values(
            {
                'cookie_policy': "This website, and certain approved third parties, use functional, "
